...
function CaseMcDs(props) {
  ...
  return (
    <div className="caseStudy__detail">
      ...
      <div className="caseStudy__detail-body">
        <h4>Wearing the hat of a Product Owner on this project, I had the opportunity to further develop a few key skills relevant to Product Design, particularly:
