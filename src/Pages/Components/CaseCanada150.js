  ...
  return (
    <div className="caseStudy__detail">
      ...
      <div className="caseStudy__detail-flow">
        <img id="c150_splash_desktop" src={"./Images/Canada150/flow.png"} alt="Case Study User Flow"></img>
        <img id="c150_splash_mobile" src={"./Images/Canada150/flow_mobile.png"} alt="Case Study User Flow mobile optimized"></img>
      </div>
